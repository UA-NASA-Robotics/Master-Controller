...
#define Motor_UART        DRV_USART_INDEX_0       //Uart2(Silicon instance) | Instance 0 (harmony) | UART2_3TX(tx) UART2_3RX(rx) (board Schematic) | PIN 52(TX) & PIN 53(RX) (Processor)
//NOTE: THIS UART channel is NOT available until the board is fixed!!!!!!!!!
#define Gyro_UART         DRV_USART_INDEX_1       //Uart4(Silicon instance) | Instance 1 (harmony) | UART1_3RX(tx) UART1_3TX(rx) (board Schematic) | PIN 17(TX) & PIN 18(RX) (Processor)
#define External_UART     DRV_USART_INDEX_2       //Uart3(Silicon instance) | Instance 2 (harmony) | UART_RX             UART_TX (board Schematic) | PIN 44(TX) & PIN 45(RX) (Processor)
